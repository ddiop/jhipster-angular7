...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', async () => {
        ...
        expect(await blogComponentsPage.getTitle()).to.eq('jhipsterApp.blog.home.title');
    });

    it('should load create Blog page', async () => {
        await blogComponentsPage.clickOnCreateButton();
        blogUpdatePage = new BlogUpdatePage();
        expect(await blogUpdatePage.getPageTitle()).to.eq('jhipsterApp.blog.home.createOrEditLabel');
    ...
    it('should delete last Blog', async () => {
        ...
        expect(await blogDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.blog.delete.question');
