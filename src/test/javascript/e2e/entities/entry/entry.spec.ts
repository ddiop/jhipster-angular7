...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', async () => {
        ...
        expect(await entryComponentsPage.getTitle()).to.eq('jhipsterApp.entry.home.title');
    });

    it('should load create Entry page', async () => {
        await entryComponentsPage.clickOnCreateButton();
        entryUpdatePage = new EntryUpdatePage();
        expect(await entryUpdatePage.getPageTitle()).to.eq('jhipsterApp.entry.home.createOrEditLabel');
    ...
    it('should delete last Entry', async () => {
        ...
        expect(await entryDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.entry.delete.question');
