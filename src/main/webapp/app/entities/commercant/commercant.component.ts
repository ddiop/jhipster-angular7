...
export class CommercantComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.commercantService
            ...
            .subscribe(
                (res: HttpResponse<ICommercant[]>) => this.paginateCommercants(res.body, res.headers),
    ...
    trackId(index: number, item: ICommercant) {
        return item.id;
    }

    registerChangeInCommercants() {
        this.eventSubscriber = this.eventManager.subscribe('commercantListModification', response => this.reset());
    }
    ...
    protected paginateCommercants(data: ICommercant[], headers: HttpHeaders) {
